  ...
  function SidebarMenuBadge({ className, ...props }, ref) {
    return (
      <div
        ...
        className={cn(
          "absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground pointer-events-none",
...
>(function SidebarMenuSkeleton({ className, showIcon = false, ...props }, ref) {
  ...
  return (
    <div ref={ref} data-sidebar="menu-skeleton" className={cn("h-8 items-center rounded-md px-2 flex gap-2", className)} {...props}>
